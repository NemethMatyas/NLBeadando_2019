<template>
  <div class="cim">Kerítés feladat</div>
  <div class="topnav">
    
    <a href="Kerites.txt" download="Kerites.txt">kerites.txt</a>
    <a href="Kerites_fel.pdf">Feladat.pdf</a>
    <a href="Kerites_jav.pdf">Javítási.pdf</a>
    <a href="https://github.com/nitslaszlo/ErettsegiKeritesTsVueJs">GitHub</a>
    <a href="https://github.com/nitslaszlo/JedlikVueJsStarter">SDK</a>  
